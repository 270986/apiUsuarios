...
namespace apiUsuarios.Controllers
{
    ...
    public class TokenController : Controller
    {
        ...
        {
           if(request.USUA_DS_LOGIN == "Mac" && request.USUA_CD_SENHA=="numsey")
         
            {
                var claims = new[]
                {
                     new Claim(ClaimTypes.Name, request.USUA_DS_LOGIN)
                };
               ...
               var token = new JwtSecurityToken(
                    issuer: "metalser.com.br", 
                    audience: "metalser.com.br",
                    claims: claims,
